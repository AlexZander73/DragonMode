...
export const RELIC_ITEMS: RelicItem[] = [
  ...
  { id: "balanced-bell", setId: "festival-of-echoes", name: "Balanced Bell", rarity: "rare", type: "lair", description: "Rings when the statement and tracked balance match—not for wealth.", craftCost: 12 },
  { id: "river-between-vaults", setId: "festival-of-echoes", name: "River Between Vaults", rarity: "rare", type: "chronicle", description: "An illustration for one movement appearing in two balances you track.", craftCost: 12 },
  { id: "restored-archive", setId: "festival-of-echoes", name: "Restored Archive Aurora", rarity: "mythic", type: "lair", description: "An aurora made from patience, careful checks, and human truth.", craftCost: 30 },
